...
# Use pkg-config to get libcurl and its dependencies dynamically.
CURL_LIBS:=$(shell pkg-config --libs --static libcurl 2>/dev/null || echo -lcurl -lssl -lcrypto -lz -lwldap32 -lbcrypt -ladvapi32 -lcrypt32 -lws2_32 -lssh2 -lzstd -lbrotlidec -lbrotlicommon -lpsl -lunistring -lidn2)
LIBS += $(CURL_LIBS)
